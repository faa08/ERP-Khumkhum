...
const MOCK_DATA: Entity[] = [
  { id: '1', name: 'Sample Name 1', parameters: 'Sample Parameters 1', isActive: true },
  { id: '2', name: 'Sample Name 2', parameters: 'Sample Parameters 2', isActive: true },
];
...
export default function QcstandardsPage() {
  ...
  const handleToggleStatus = (item: Entity) => {
    ...
    setConfirmDialog({
      isOpen: true,
      title: isActivating ? 'Activate QC Standard' : 'Deactivate QC Standard',
      ...
      onConfirm: async () => {
        ...
        toast.success(`QC Standard ${isActivating ? 'activated' : 'deactivated'}`);
    ...
    <div>
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-4)' }}>
          ...
          <FormField label="Parameters" required><Input defaultValue={selectedItem?.parameters || ''} /></FormField>
        </div>
      </Drawer>
