    ...
    items: [
      {
        ...
        children: [
          ...
          { id: 'terminal-pekerja', label: 'Terminal Sesi Kerja', href: '/master/terminal-pekerja', requiredPermission: 'production' },
          { id: 'waktu-baku', label: 'Master Waktu Baku', href: '/master/waktu-baku', requiredPermission: 'production' },
        ],
      },
    ],
  },
